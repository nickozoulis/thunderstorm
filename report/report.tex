...
\begin{algorithm}[H]
	...
	\begin{algorithmic}[1]
		...
		\Function{Silhouette Coefficient}{$Point$ $p$, $Clusterhead$ $c$}
	...
	\begin{algorithmic}[1]
		...
		\Function{Silhouette Score}{$Dataset$ $d$, $Clusterheads$ $c$}
		
		\ForEach {Point p in Dataset d}
			\ForEach {Clusterhead file c}
				\State $silhouettes$ $\pluseq \Call {Silhouette Coefficient}{d,c}$
