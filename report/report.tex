...
\subsubsection{HBase design}
Our HBase design consists of 5 HTables:
...
\begin{enumerate}
	...
	\item Messages: Stores an Integer counter. This counter is updated by Batch layer at the end of each round of query computation and is used by Stream layer in order to detect when a computation round has finished and should synchronize its views with Batch layer as feeding source.
\end{enumerate}
