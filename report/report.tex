...
\begin{tabbing}
	...
	\> 1. \> JavaRDD$\textless$String$\textgreater$ textFile = spark.textFile("hdfs://..."); \\
	\> 2. \> JavaRDD$\textless$String$\textgreater$ words = textFile.flatMap( \\
	\>    \>  \> new FlatMapFunction$\textless$String, String$\textgreater$() \{ \\
	\>    \>  \> \> public Iterable$\textless$String$\textgreater$ call(String s) \{ \\
	\>    \>  \> \> \> return Arrays.asList(s.split(" ")); \\
	\>    \>  \> \> \} \\
	\>    \>  \> \}); \\
	\> 3. \> JavaPairRDD$\textless$String, Integer$\textgreater$ pairs = words.mapToPair( \\
	...
	\>    \>  \> \> \} \\
	\>    \>  \> \}); \\
	\> 4. \> JavaPairRDD$\textless$String, Integer$\textgreater$ counts = pairs.reduceByKey( \\
