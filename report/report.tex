...
The classical hello word program for the map-reduce framework is a work count. Work count can be implemented in spark using the reduceByKey operation as follows:
...
\begin{figure}[H]
	\centering	
	\includegraphics[scale=0.5]{execution_time_k_5}
